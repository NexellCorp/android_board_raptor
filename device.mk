...
PRODUCT_COPY_FILES += \
	device/nexell/raptor/init.raptor.usb.rc:root/init.raptor.usb.rc \
	device/nexell/raptor/ueventd.raptor.rc:root/ueventd.raptor.rc
...
PRODUCT_COPY_FILES += \
	device/nexell/raptor/mixer_paths.xml:system/etc/mixer_paths.xml \
	device/nexell/raptor/audio_policy_configuration.xml:system/etc/audio_policy_configuration.xml \
	device/nexell/raptor/audio_policy_volumes.xml:system/etc/audio_policy_volumes.xml \
	device/nexell/raptor/a2dp_audio_policy_configuration.xml:system/etc/a2dp_audio_policy_configuration.xml \
	device/nexell/raptor/usb_audio_policy_configuration.xml:system/etc/usb_audio_policy_configuration.xml \
	device/nexell/raptor/r_submix_audio_policy_configuration.xml:system/etc/r_submix_audio_policy_configuration.xml \
	device/nexell/raptor/default_volume_tables.xml:system/etc/default_volume_tables.xml

PRODUCT_COPY_FILES += \
	device/nexell/raptor/audio/tiny_hw.raptor.xml:system/etc/tiny_hw.raptor.xml \
	device/nexell/raptor/audio/audio_policy.conf:system/etc/audio_policy.conf

PRODUCT_COPY_FILES += \
	frameworks/av/media/libstagefright/data/media_codecs_google_audio.xml:system/etc/media_codecs_google_audio.xml \
	device/nexell/raptor/media_codecs.xml:system/etc/media_codecs.xml \
	device/nexell/raptor/media_profiles.xml:system/etc/media_profiles.xml \
...
# input
PRODUCT_COPY_FILES += \
	device/nexell/raptor/gpio_keys.kl:system/usr/keylayout/gpio_keys.kl \
	device/nexell/raptor/gpio_keys.kcm:system/usr/keychars/gpio_keys.kcm

# hardware features
PRODUCT_COPY_FILES += \
	device/nexell/raptor/tablet_core_hardware.xml:system/etc/permissions/tablet_core_hardware.xml \
...
# wallpaper
PRODUCT_COPY_FILES += \
	device/nexell/raptor/wallpaper:/data/system/users/0/wallpaper \
	device/nexell/raptor/wallpaper_orig:/data/system/users/0/wallpaper_orig \
	device/nexell/raptor/wallpaper_info.xml:/data/system/users/0/wallpaper_info.xml
...
DEVICE_PACKAGE_OVERLAYS := device/nexell/raptor/overlay
